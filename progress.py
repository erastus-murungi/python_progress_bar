...
class FileDownloadThreaded(DeterminateProgressItem, DownloadingMixIn):
    ...
    def __init__(self, url: str, filename: str = ""):
        ...
        self.download_state: FileDownloadThreaded.DownloadState = (
            FileDownloadThreaded.DownloadState()
        )
    ...
    def start_progress(self) -> bool:
        ...
        def download_file(download_state: FileDownloadThreaded.DownloadState):
